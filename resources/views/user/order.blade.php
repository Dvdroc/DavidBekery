        ...
        <div class="layout-container flex h-full grow flex-col">
            <div class="max-w-4xl mx-auto rounded-xl shadow-lg p-4 mt-10 border bg-white">
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="md:w-1/2 md:pl-4">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="space-y-1">
                                <div class="flex items-center"><span class="w-4 text-sm">5</span><div class="w-full h-2 bg-gray-200 rounded mx-2"><div class="h-full bg-yellow-400 rounded" style="width: 0%"></div></div><span class="text-xs text-gray-500">0%</span></div>
                            </div>
                ...
                <div class="mt-6 bg-white rounded-lg p-4 shadow-inner border-t">
                    ...
                    <textarea class="w-full border border-gray-300 rounded p-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#ee2b5c]" rows="3" placeholder="Tulis komentarmu di sini..."></textarea>
                    <button class="mt-3 bg-[#ee2b5c] hover:bg-red-700 text-white text-sm px-4 py-2 rounded transition">Kirim</button>
                </div>
            </div>
        </div>
    </div>
